// Vendored from `three-ik@0.1.0` (MIT, Jordan Santell). Original repo is
// unmaintained and its 2018-era build references symbols removed from
// modern three.js — `ConeBufferGeometry` (now `ConeGeometry`) and the
// global `THREE.Math` namespace (now `THREE.MathUtils`). DWEA-17 owns this
// copy. Two-line patch only; algorithmic body is verbatim.
import {
  AxesHelper,
  Color,
